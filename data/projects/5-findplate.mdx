---
id: 5
image: "/project/findplate.png"
name: "FindPlate"
overview: "A comprehensive starter template for Next.js projects, featuring production-ready components, landing pages, server actions, and seamless email integration for rapid development."
status: "published"
link: "https://plate.findmalek.com"
href: "/projects/findplate"
tags: ["Next.js", "Starter Template", "Server Actions"]
---
...
You can explore the project’s codebase on [GitHub](https://github.com/FindMalek/findplate) and visit the live website at [FindPlate](https://plate.findmalek.com) to see it in action.
