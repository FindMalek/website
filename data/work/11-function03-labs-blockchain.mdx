...
skills: ["React", "Next.js", "TailwindCSS", "MongoDB", "Web3Modal", "Ethers.js"]
---

### Function03 Labs: Pioneering Blockchain and Web3 Innovations

After starting part-time as a UX Engineer (see that role for the earlier period), I moved to full-time as **UX Engineer and Blockchain Developer**, focusing on developing cutting-edge solutions in the blockchain and Web3 space. My role involved creating secure and user-friendly applications, refactoring existing projects for improved performance, and contributing to the rebranding of marketing pages for high-profile projects.
