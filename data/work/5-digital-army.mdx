...
# End date is inferred as immediately preceding Function03 Labs' confirmed
# June 2023 start (Malek: "when i ended with digital army i joined with
# function03") -- start month (February) is confirmed, end month is not.
type: "freelance"
startDate: "February, 2021"
endDate: "May, 2023"
place: "Remote"
location: "Tunisia, Ariana"
link: "https://digital-army.clients.malek.engineering"
href: "/work/digital-army"
skills: ["React", "Next.js", "Tailwind CSS", "shadcn/ui", "Shopify"]
---
...
You can explore the project’s codebase on [GitHub](https://github.com/FindMalek/Digi.ar) and visit the live website at [Digital Army](https://digital-army.clients.malek.engineering).

#### **E-commerce Project: LilyPharma**

I built a custom Shopify template and product pipeline for **LilyPharma**, an e-commerce client, centered on AI-assisted catalog creation at scale.

- **Custom Shopify Template:** Designed and built a bespoke Shopify theme for the store.
- **AI-Assisted Catalog:** Uploaded 1,000+ products with AI-generated product images and descriptions, using AI suggestions to speed up catalog creation.
