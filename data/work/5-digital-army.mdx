...
# TODO(#66): issue #66 describes Digital Army as running "approximately 2021
# to 2023", which conflicts with the dates below (Feb-Apr 2023). Left
# unchanged pending confirmation from Malek on which range is correct - do
# not guess.
type: "freelance"
